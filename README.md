...
## Установка и запуск
**Сервер:**<br/>
Клонировать репозиторий https://github.com/Vollmind/otus-project-server  <br/>
Выполнить:
```
make prod
```
...
Во время сборки будет создан пользователь admin/admin. Настоятельно рекоммендуется сменить пароль.
